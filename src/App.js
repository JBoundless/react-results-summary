  ...
  return (
    <div className="md:flex md:items-center md:justify-center md:h-screen md:max-w-2xl md:mx-auto">
      <section className="md:flex bg-white shadow rounded-3xl">
        <div className="bg-indigo-600 p-8 text-white text-center rounded-b-3xl md:flex-1 md:rounded-3xl">
          <p className="mb-6">Your Result</p>
          <div className="flex items-center justify-center">
            <p className="bg-indigo-700 w-24 h-24 md:w-40 md:h-40 flex flex-col items-center justify-center gap-1 rounded-full text-white text-3xl md:text-6xl font-bold">
            ...
            {items.map((item, index) => (
              ...
              >
                ...
                <p className="flex items-center gap-2 text-slate-500">
                  <span className="text-skate-700 font-bold">{item.score}</span>{' '}
                  / 100
                </p>
              </div>
            ))}
